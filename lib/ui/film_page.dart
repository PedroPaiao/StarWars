              ...
              : SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: Text('Planetas participantes: ',
                            style: TextStyle(
                                color: Colors.white,
                                decoration: TextDecoration.underline,
                                fontSize: 13)),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children:
                            model.films[index]['planets'].map<Widget>((_item) {
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children:
                            model.films[index]['vehicles'].map<Widget>((_item) {
                          return Text(_item['name']);
                        }).toList(),
                      ),
                      Padding(
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children:
                            model.films[index]['species'].map<Widget>((_item) {
                          return Text(_item['name']);
                        }).toList(),
                      ), //Padrao de Texto
                    ],
